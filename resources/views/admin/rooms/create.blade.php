        ...
        <div class="card-body">
            <form action="{{route('backend.rooms.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bed') is-invalid @enderror" value="{{old('bed')}}" id="bed" name="bed">
                    @error('bed')
                        <div class="invalid-feedback">{{ $message}} </div>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('bath') is-invalid @enderror" value="{{old('bath')}}" id="bath" name="bath">
                    @error('bath')
                        <div class="invalid-feedback">{{ $message}} </div>
                    @enderror
                </div>
